...
from typing import List, Optional, Iterator, Type, Dict, Any

from customer_service.hjf_ai.dialogue_understanding.stack.stack_frame import StackFrame, FlowStackFrame, \
...
class DialogueStack:
    ...
    def pop_to_flow(self, flow_id: str) -> List[StackFrame]:
        ...
        while self.frames:
            top = self.top()
            if isinstance(top, FlowStackFrame) and top.frame_id == flow_id:
                break
