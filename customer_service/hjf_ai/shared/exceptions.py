...
class ModelNotFound(CommonException):
    """模型未找到异常
...
class ModelLoadException(CommonException):
    """模型加载异常
...
class ModelTrainingException(CommonException):
    """模型训练异常
...
class TrackerStoreException(CommonException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(CommonException):
    """对话理解异常基类
...
class ActionException(CommonException):
    """Action异常基类
...
class ChannelException(CommonException):
    """通道异常基类
...
class GraphException(CommonException):
    """图引擎异常基类
...
class RetrievalException(CommonException):
    """检索异常基类
