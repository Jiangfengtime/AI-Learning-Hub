...
from customer_service.hjf_ai.shared.exceptions import TrackerStoreConnectionError, TrackerSerializationError, \
    ...
    async def _ensure_initialized(self) -> None:
        ...
        try:
            ...
            self._table = Table(
                ...
                Column("state", SQLText, primary_key=False),
