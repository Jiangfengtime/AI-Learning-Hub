...
from typing import Text, Any, Optional, List, Dict, Union, Type

from atguigu_ai.shared.exceptions import InvalidSlotValueError
from customer_service.hjf_ai.shared.constants import (
    SLOT_TYPE_ANY,
    SLOT_TYPE_BOOL,
...
class Slot(ABC):
    ...
    def __init__(
        ...
        if isinstance(mapping_type, str):
            self.mapping_type = SlotMappingType(mapping_type)
